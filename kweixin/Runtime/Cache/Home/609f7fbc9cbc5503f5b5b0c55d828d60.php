      ...
      <?php if($search_button or !empty($model[extend])): ?><div class="table-bar">
        ...
        <?php if($search_button): ?><div class="search-form fr cf">
          <div class="sleft">
            ...
            <input type="text" name="nickname" class="search-input" value="<?php echo I('title');?>" placeholder="请输入用户名">
          ...
          <table cellpadding="0" cellspacing="1">
            ...
            <tbody>
              <?php if(is_array($list_data)): $i = 0; $__LIST__ = $list_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                  <?php if($check_all): ?><td><input class="ids regular-checkbox" type="checkbox" value="<?php echo ($data['id']); ?>" name="ids[]" id="check_<?php echo ($data['id']); ?>"><label for="check_<?php echo ($data['id']); ?>"/></td><?php endif; ?>
