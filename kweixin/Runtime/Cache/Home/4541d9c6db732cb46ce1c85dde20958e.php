...
<?php switch($addons_config["editor_type"]): case "1": ?>
	...
	<?php case "2": ?>
		<input type="hidden" name="parse" value="0">
		<?php if(($addons_config["editor_wysiwyg"]) == "1"): ?><link rel="stylesheet" href="/kweixin/Public/static/kindeditor/default/default.css?v=<?php echo SITE_VERSION;?>" />
			<script charset="utf-8" src="/kweixin/Public/static/kindeditor/kindeditor-min.js"></script>
			<script charset="utf-8" src="/kweixin/Public/static/kindeditor/zh_CN.js?v=<?php echo SITE_VERSION;?>"></script>
			<script type="text/javascript">
				var editor;
		...
		<?php else: ?>
			...
			<script type="text/javascript" charset="utf-8" src="/kweixin/Public/static/ueditor/ueditor.config.js?v=<?php echo SITE_VERSION;?>"></script>
			<script type="text/javascript" charset="utf-8" src="/kweixin/Public/static/ueditor/ueditor.all.js?v=<?php echo SITE_VERSION;?>"></script>
			<script type="text/javascript" charset="utf-8" src="/kweixin/Public/static/ueditor/lang/zh-cn/zh-cn.js?v=<?php echo SITE_VERSION;?>"></script>
         
			<script type="text/javascript">
				$('textarea[name="<?php echo ($addons_data["name"]); ?>"]').attr('id', 'editor_id_<?php echo ($addons_data["name"]); ?>');
				window.UEDITOR_HOME_URL = "/kweixin/Public/static/ueditor/";
	...
	<?php case "3": ?>
		<script type="text/javascript" src="/kweixin/Public/static/jquery-migrate-1.2.1.min.js"></script>
		<script charset="utf-8" src="/kweixin/Public/static/xheditor/xheditor-1.2.1.min.js"></script>
		<script charset="utf-8" src="/kweixin/Public/static/xheditor/xheditor_lang/zh-cn.js?v=<?php echo SITE_VERSION;?>"></script>
		<script type="text/javascript" src="/kweixin/Public/static/xheditor/xheditor_plugins/ubb.js?v=<?php echo SITE_VERSION;?>"></script>
		<script type="text/javascript">
	...
	<?php case "4": ?>
		<link rel="stylesheet" href="/kweixin/Public/static/thinkeditor/skin/default/style.css?v=<?php echo SITE_VERSION;?>" />
		<script type="text/javascript" src="/kweixin/Public/static/jquery-migrate-1.2.1.min.js"></script>
		<script type="text/javascript" src="/kweixin/Public/static/thinkeditor/jquery.thinkeditor.js?v=<?php echo SITE_VERSION;?>"></script>
		<script type="text/javascript">
			$(function(){
				$('textarea[name="<?php echo ($addons_data["name"]); ?>"]').attr('id', 'editor_id_<?php echo ($addons_data["name"]); ?>');
				var options = {
