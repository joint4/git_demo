...
<link href="/kweixin/Public/static/font-awesome/css/font-awesome.min.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<link href="/kweixin/Public/Home/css/base.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<link href="/kweixin/Public/Home/css/module.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<link href="/kweixin/Public/Home/css/weiphp.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
<!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
<!--[if lt IE 9]>
<script src="/kweixin/Public/static/bootstrap/js/html5shiv.js?v=<?php echo SITE_VERSION;?>"></script>
<![endif]-->

<!--[if lt IE 9]>
<script type="text/javascript" src="/kweixin/Public/static/jquery-1.10.2.min.js"></script>
<![endif]-->
<!--[if gte IE 9]><!-->
<script type="text/javascript" src="/kweixin/Public/static/jquery-2.0.3.min.js"></script>
<script type="text/javascript" src="/kweixin/Public/static/bootstrap/js/bootstrap.min.js"></script>
<script type="text/javascript" src="/kweixin/Public/static/uploadify/jquery.uploadify.min.js"></script>
<script type="text/javascript" src="/kweixin/Public/Home/js/dialog.js?v=<?php echo SITE_VERSION;?>"></script>
<script type="text/javascript" src="/kweixin/Public/Home/js/admin_common.js?v=<?php echo SITE_VERSION;?>"></script>
<script type="text/javascript" src="/kweixin/Public/Home/js/admin_image.js?v=<?php echo SITE_VERSION;?>"></script>
<script type="text/javascript">
var  STATIC = "/kweixin/Public/static";
var  ROOT = "/kweixin";
</script>
<!--<![endif]-->
...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
       <a class="brand" title="<?php echo C('WEB_SITE_TITLE');?>" href="<?php echo U('index/index');?>"><img src="/kweixin/Public/Home/images/top_logo.png?v=<?php echo SITE_VERSION;?>" title="<?php echo C('WEB_SITE_TITLE');?>"/></a>
      ...
      <div class="table-bar">
        <div class="fl">
          <?php if(empty($model["extend"])): ?><div class="tools">
				餐厅：
				<select id="sel_ct">
					<?php if(is_array($list_ctdata)): $i = 0; $__LIST__ = $list_ctdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ctdata): $mod = ($i % 2 );++$i;?><option value="<?php echo ($ctdata["id"]); ?>" <?php if($ctdata["id"] == $ctid){ echo 'selected="selected"';} ?> ><?php echo ($ctdata["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>				
				<?php if($add_button): $add_url || $add_url = U('add?ctid='.$ctid.'&model='.$model['id']); ?><a class="btn" href="<?php echo ($add_url); ?>">新增</a><?php endif; ?>
				<?php if($add_button): ?><a class="btn" id="a_fzadd" href="#div_selfzadd">复制添加</a><?php endif; ?>
				<?php if($del_button): $del_url || $del_url = U('del?ctid='.$ctid.'&model='.$model['id']); ?><button class="btn ajax-post confirm" target-form="ids" url="<?php echo ($del_url); ?>">删 除</button><?php endif; ?>                
				&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn" id="a_yhset" href="<?php echo U('yhset?ctid='.$ctid); ?>">优惠菜品设置</a>
			</div><?php endif; ?>
        </div>
        <!-- 高级搜索 -->
		...
		<div id="div_selfzadd" style="width:250px;">
			...
			<div>
				<select id="sel_ctfrom">
					<?php if(is_array($list_ctdata)): $i = 0; $__LIST__ = $list_ctdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ctdata): $mod = ($i % 2 );++$i;?><option value="<?php echo ($ctdata["id"]); ?>" ><?php echo ($ctdata["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</div>
			<div>
				的优惠复制添加到餐厅
...
(function(){
	var ThinkPHP = window.Think = {
		"ROOT"   : "/kweixin", //当前网站地址
		"APP"    : "/kweixin/index.php?s=", //当前项目地址
		"PUBLIC" : "/kweixin/Public", //项目公共目录地址
...
$(function(){
	...
	$("#sel_ct").change(function(){
		window.location.href = "<?php echo ($sel_ct_url); ?>".replace("%7Bid%7D",$(this).val());
	});
