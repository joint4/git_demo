...
<link href="<?php echo ADDON_PUBLIC_PATH;?>/css.css" rel="stylesheet" type="text/css">
...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?>     
      <div class="cf">
        <div class="fl">
          <?php if(empty($model["extend"])): ?><div class="tools">
				<?php if($add_button): $add_url || $add_url = U('add?model='.$model['id']); ?><a class="btn" href="<?php echo ($add_url); ?>">创建相册</a><?php endif; ?>
					</div><?php endif; ?>
        </div>
      ...
      <ul class="Photo_select">
                    ...
                    <div class='Photo_item_pic'>
                        <a href=" <?php echo U('photo_pic?model='.$model['id'].'&pid='.$vo[id]);?>">	<img src="<?php echo (get_picture_url($vo["cover"])); ?>" />
                        	</a></div>
                        <p>
                        <label ><?php echo ($vo["title"]); ?>
 </label></p>
  <a href=" <?php echo U('photo_pic?model='.$model['id'].'&pid='.$vo[id]);?>">	查看相册 
                        	</a>
  <a  class="confirm" href=" <?php echo U('edit?model='.$model['id'].'&id='.$vo[id]);?>">编辑</a>
 <a   onClick="return confirm('确认要删除？')" href=" <?php echo U('del?model='.$model['id'].'&id='.$vo[id]);?>">删除</a>
 </div>
                    </li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
