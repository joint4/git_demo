...
<link href="/kweixin /Addons/Diy/View/default/Public/css/diy.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet" type="text/css">
<script src="/kweixin /Addons/Diy/View/default/Public/js/diy.js?v=<?php echo SITE_VERSION;?>" type="text/javascript"></script> 
